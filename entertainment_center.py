...
Arrival = media.Movie(
    "Arrival",
    "Taking place after alien crafts "
    "land around the world, an expert"
    " linguist is recruited by the military"
    " to determine whether they come "
    "in peace or are a threat.",
...
Passengers = media.Movie(
    "Passengers",
    "Jennifer Lawrence and Chris Pratt are two passengers "
    "onboard a spaceship transporting",
...
War_for_the_planet = media.Movie(
    "War for the Planet of the Apes ",
    "A nation of genetically evolved apes"
    " led by Caesar become embroiled"
    " in a battle with an army of humans.",
